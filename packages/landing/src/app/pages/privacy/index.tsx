...
export const Privacy = (): JSX.Element => {
  ...
  return (
    <>
    <Helmet>
      <title>Webare - Privacy Policy</title>
    </Helmet>
      <Container>
        <Content>
          ...
          <Text>
            ...
            Identifer: to identify user uniquely. Which helps us improving the
            app by blocking any malicious user. The company does not user device
          ...
          <Text>
            ...
            company does not disclose your personal information to other
            companies or organizations that are not related to the service.
            However, we may provide personal information without exception, in
            the following cases:
          </Text>
          <Text>
            - If you believe that you must disclose personal information in
            order to take legal action against a person who violates the
            Company's Terms of Use, uses the Company's services, or has
            committed an offense that offends others
          </Text>
          <Text>
            - In accordance with the provisions of the Act or for the purpose of
            investigation, according to the procedure and method prescribed by
            the Act, if the request of the investigating agency
          </Text>
          ...
          <Text>
            Dynnsoft will take all steps reasonably necessary to ensure that
          ...
          <Text>
            In addition, we are responding to information leaks caused by
            internal intrusions through a system that distinguishes access
            rights to member information and security education.
          </Text>
          <Text>
            <b>Anonymous Messages</b>: Random Chat stores messages anonymously
            for a limited time. Those messages gets deleted after random
            moderation.
          </Text>
          <Text>
